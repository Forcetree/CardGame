...
public class ForgeCard : Card
{
    ...
    protected override void AssignDefaultSettings(CardBuilder builder)
    {
        ...
        this.name = builder.Name ?? $"{CardTypeName} | Forge Card | {PlayHandler.myDeck.CardCounter}";
        this.title = builder.Title ?? $"{CardTypeName} Forge Card";
        this.flavor = builder.Flavor ?? "Forgenum Lorum Ipsum";
    }
